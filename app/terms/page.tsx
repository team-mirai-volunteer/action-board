    ...
    <div className="max-w-4xl mx-auto p-6 bg-white">
      <div className="mb-8">
        ...
        <p className="text-sm-custom font-normal text-black text-justify">
          この利用規約（以下「本規約」といいます）は、政治団体「チームはやま」（以下「当団体」といいます）が提供するウェブサービス「アクションボード」（以下「本サービス」といいます）の利用条件を定めるものです。本サービスのご利用にあたっては、本規約に同意いただく必要があります。同意いただけない場合は、本サービスをご利用いただけません。
        </p>
      </div>
