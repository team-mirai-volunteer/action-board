...
ENV HUBSPOT_CONTACT_LIST_ID=${HUBSPOT_CONTACT_LIST_ID}
...
RUN SENTRY_AUTH_TOKEN=${SENTRY_AUTH_TOKEN} LINE_CLIENT_SECRET=${LINE_CLIENT_SECRET} HUBSPOT_API_KEY=${HUBSPOT_API_KEY} npm run build
