...
values  
('0cc2f4f9-ab0a-480c-c1e2-442513421dfc', 'チームはやまのことを知ろう', 100, 'DEFAULT'),
('8b36a669-3457-0b67-308b-b4b8b0a3356d', 'チームはやまをフォローしよう', 200, 'DEFAULT'),
...
-- -- 1. チームはやまのことを知ろう
-- --   (coalesce((select id from missions where title = 'チームはやまのホームページを見てみよう'), '00000000-0000-0000-0000-000000000000'), '0cc2f4f9-ab0a-480c-c1e2-442513421dfc', 100),
-- --   (coalesce((select id from missions where title = 'チームはやまクイズ'), '00000000-0000-0000-0000-000000000000'), '0cc2f4f9-ab0a-480c-c1e2-442513421dfc', 200),
...
-- --   (coalesce((select id from missions where title = 'チームはやまのマニフェスト(要約版)をみてみよう！'), '00000000-0000-0000-0000-000000000000'), '0cc2f4f9-ab0a-480c-c1e2-442513421dfc', 500),
...
--   (coalesce((select id from missions where title = 'チームはやまの公式Xをフォローしよう'), '00000000-0000-0000-0000-000000000000'), '8b36a669-3457-0b67-308b-b4b8b0a3356d', 300),
...
-- -- 4. いいねで応援しよう
-- --   (coalesce((select id from missions where title = 'YouTubeでチームはやま動画に高評価をつけよう'), '00000000-0000-0000-0000-000000000000'), '504a2520-23e3-e49b-e3f8-9e97981a1d03', 100),
-- --   (coalesce((select id from missions where title = 'TikTokでチームはやま動画に♡をつけよう'), '00000000-0000-0000-0000-000000000000'), '504a2520-23e3-e49b-e3f8-9e97981a1d03', 200),
-- --   (coalesce((select id from missions where title = 'Xでチームはやま投稿に♡をつけよう'), '00000000-0000-0000-0000-000000000000'), '504a2520-23e3-e49b-e3f8-9e97981a1d03', 300),
-- --   (coalesce((select id from missions where title = 'noteでチームはやま記事にスキ♡をつけよう'), '00000000-0000-0000-0000-000000000000'), '504a2520-23e3-e49b-e3f8-9e97981a1d03', 400),
-- --   (coalesce((select id from missions where title = 'Instagramでチームはやま投稿に♡をつけよう'), '00000000-0000-0000-0000-000000000000'), '504a2520-23e3-e49b-e3f8-9e97981a1d03', 500),
...
--   (coalesce((select id from missions where title = 'Xでチームはやまの投稿をリポストしよう'), '00000000-0000-0000-0000-000000000000'), '07f654ee-d1da-328b-2443-fefa3c8d3a47', 200),
--   (coalesce((select id from missions where title = 'Xでチームはやまに関する投稿をしよう'), '00000000-0000-0000-0000-000000000000'), '07f654ee-d1da-328b-2443-fefa3c8d3a47', 300),
--   (coalesce((select id from missions where title = 'チームはやまの仲間を増やそう'), '00000000-0000-0000-0000-000000000000'), '07f654ee-d1da-328b-2443-fefa3c8d3a47', 400),
...
-- -- 6. 地域で活動しよう
--   (coalesce((select id from missions where title = 'チームはやまの機関誌をポスティングしよう'), '00000000-0000-0000-0000-000000000000'), 'b2109f3b-2389-54e0-0cb9-2dcb4e421994', 100),
...
-- -- 7. クイズで学ぼう
-- --   (coalesce((select id from missions where title = 'チームはやまクイズ'), '00000000-0000-0000-0000-000000000000'), '720b511c-8be3-8e0c-e2ae-d95be1613281', 100),
...
-- --   (coalesce((select id from missions where title = 'チームはやま政策クイズ'), '00000000-0000-0000-0000-000000000000'), '720b511c-8be3-8e0c-e2ae-d95be1613281', 300),
...
-- --   (coalesce((select id from missions where title = 'チームはやまのマニフェスト(要約版)をみてみよう！'), '00000000-0000-0000-0000-000000000000'), '19bb0960-86af-4162-2351-530f664ac5b5', 200),
-- --   (coalesce((select id from missions where title = 'チームはやま政策クイズ'), '00000000-0000-0000-0000-000000000000'), '19bb0960-86af-4162-2351-530f664ac5b5', 300),
...
-- --   (coalesce((select id from missions where title = 'YouTubeでチームはやま動画に高評価をつけよう'), '00000000-0000-0000-0000-000000000000'), '373fe78b-9e63-96f7-40af-650120a599f1', 300),
...
-- --   (coalesce((select id from missions where title = 'TikTokでチームはやま動画に♡をつけよう'), '00000000-0000-0000-0000-000000000000'), '91a10bef-fab0-1a99-c8d5-4353cd39c402', 200),

-- -- 11. Xで応援しよう
--   (coalesce((select id from missions where title = 'チームはやまの公式Xをフォローしよう'), '00000000-0000-0000-0000-000000000000'), '089ed58c-9bbc-fb5d-8b51-e608906a965c', 100),
--   (coalesce((select id from missions where title = 'Xでチームはやまの投稿をリポストしよう'), '00000000-0000-0000-0000-000000000000'), '089ed58c-9bbc-fb5d-8b51-e608906a965c', 200),
--   (coalesce((select id from missions where title = 'Xでチームはやまに関する投稿をしよう'), '00000000-0000-0000-0000-000000000000'), '089ed58c-9bbc-fb5d-8b51-e608906a965c', 300),
-- --   (coalesce((select id from missions where title = 'Xでチームはやま投稿に♡をつけよう'), '00000000-0000-0000-0000-000000000000'), '089ed58c-9bbc-fb5d-8b51-e608906a965c', 400),
...
-- --   (coalesce((select id from missions where title = 'noteでチームはやま記事にスキ♡をつけよう'), '00000000-0000-0000-0000-000000000000'), '6d4a5924-5411-277c-9c7d-911df2b717a1', 200),
