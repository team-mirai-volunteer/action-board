...
VALUES
  ...
  ('2c5f7173-48be-4989-9d1b-c749fd56ae44', 'チームみらいの公式Xをフォローしよう', '/img/mission_fallback.svg', '最新の政策情報やイベント情報、ボランティアの動きなどをチェックするなら、まずは公式X（旧Twitter）をフォロー！<a href="https://twitter.com/team_mirai_jp" class="twitter-follow-button" data-show-count="false" data-lang="ja" data-screen-name="team_mirai_jp">Follow @team_mirai</a><script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>参加者の投稿や注目の提案も流れてきます。', 1, NULL, 'TEXT', 1, 'https://tibsocpjqvxxipszbwui.supabase.co/storage/v1/object/public/ogp//11_follow_teammirai_x.png', 'あなたのXアカウント名'),
  ('0f4f16e5-35eb-4756-a966-607895a61b0e', '安野たかひろの公式Xをフォローしよう', '/img/mission_fallback.svg', '新党チームみらい党首・安野たかひろの公式X（旧Twitter）をフォローして発信をチェック！<a href="https://twitter.com/takahiroanno" class="twitter-follow-button" data-show-count="false" data-lang="ja" data-screen-name="takahiroanno">Follow @takahiroanno</a><script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>政策への想いや、未来を描く視点が日々の投稿から伝わってきます。', 1, NULL, 'TEXT', 1, 'https://tibsocpjqvxxipszbwui.supabase.co/storage/v1/object/public/ogp//5_follow_anno_x.png', 'あなたのXアカウント名'),
