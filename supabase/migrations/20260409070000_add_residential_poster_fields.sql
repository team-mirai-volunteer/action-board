...
ALTER TABLE residential_poster_placements ADD COLUMN location_type TEXT CONSTRAINT residential_poster_placements_location_type_check CHECK (location_type IN ('home', 'store_office', 'public_facility', 'other'));
