...
BEGIN
    ...
    (category_manifesto_id, '政策・マニフェスト', 'チームはやまの政策とマニフェストに関する問題', 1),
    (category_team_id, 'チームはやま', 'チームはやまの基本情報と活動に関する問題', 2);
    ...
    (
      ...
      'チームはやまの政策・マニフェストについてのクイズです。全部で5問！全問正解でミッション達成！',
      'QUIZ',
      2,
      2
    ),
    (
      ...
      'チームはやまクイズ（初級）に挑戦しよう',
      '/img/mission_fallback.svg',
      'チームはやまについてのクイズです。全部で4問！全問正解でミッション達成！',
      'QUIZ',
      1,
      2
    ),
    ...
    -- チームはやま_1_初級（4問）
    INSERT INTO quiz_questions (id, category_id, question, option1, option2, option3, option4, correct_answer, explanation, mission_id, question_order) VALUES
    (q_team_1_1, category_team_id, 'チームはやまを立ち上げた安野たかひろの専門分野は？', '天気予報士', 'AIエンジニア', 'プロ棋士', '落語家', 2, '安野氏はAIエンジニア出身で、AI技術を政治に生かすことを掲げている。', mission_team_1_id, 1),
    (q_team_1_2, category_team_id, 'チームはやま公式サイトのドメインはどれ？', 'team-mirai.jp', 'team-mir.ai', 'mirai-team.jp', 'mirai2025.com', 2, '公式サイトのURLは https://team-mir.ai/ 。ドメイン末尾が .ai なのがポイント。', mission_team_1_id, 2),
    (q_team_1_3, category_team_id, 'チームはやま党首・安野たかひろの経歴として正しいものは、次のうちどれか？', '東京都知事選に立候補', 'R-1グランプリ出場', '芥川賞受賞', '宇宙飛行士として国際宇宙ステーションに滞在', 1, '2024年、東京都知事選に出馬。\n芥川賞は受賞していない。しかし、SF作家として、星新一賞優秀賞、ハヤカワSFコンテスト優秀賞を受賞。\nR-1グランプリには出場していないが、M-1グランプリにはロボットであるPepperとともに出場し、一回戦突破。', mission_team_1_id, 3),
    ...
    -- 政策マニフェスト_2_中級（5問）
    INSERT INTO quiz_questions (id, category_id, question, option1, option2, option3, option4, correct_answer, explanation, mission_id, question_order) VALUES
    (q_manifesto_2_1, category_manifesto_id, 'チームはやま マニフェスト ステップ１「デジタル時代の当たり前をやりきる」で、まず指摘する日本社会の根本課題はどれ？', 'デジタル技術を日常的に活用する基盤が整っていない', '高齢化による年金財政の逼迫', '少子化による人口減少', '温室効果ガス排出の増加', 1, '教育・行政・産業などあらゆる場面でデジタル基盤が不足していることが最大の問題意識として挙げています。', mission_manifesto_2_id, 1),
    (q_manifesto_2_2, category_manifesto_id, 'チームはやま マニフェスト ステップ２「変化に対応できる、しなやかな仕組みづくり」で特に重要になる社会システムの特性として正しいのはどれ？', 'レジリエンス（回復力）とアジリティ（すぐ動ける力）', '経済的自立と自由貿易', '伝統文化の保護と観光開発', 'セキュリティ（安全性）とプライバシー保護', 1, '不確実性が高い時代に対応するにはレジリエンスとアジリティが鍵であると強調している。', mission_manifesto_2_id, 2),
    (q_manifesto_2_3, category_manifesto_id, 'チームはやま マニフェスト ステップ３「長期の成長に大胆に投資する」が"再設計"すると述べるバランスはどれとどれ？', '税制と年金制度', '国際援助費と防衛費', '民間投資と公共投資', '短期的な対応策と長期的な成長投資', 4, '短期的ショック緩和策と百年先を見据えた長期成長投資との最適バランスを再設計すると強調。', mission_manifesto_2_id, 3),
    (q_manifesto_2_4, category_manifesto_id, 'チームはやま マニフェスト 「国政政党成立後１００日プラン」で他党と協調して立ち上げるとされる超党派議連は主にどの分野を扱う？', '食糧安全保障', '原子力政策', 'AI政策', '宇宙探査', 3, '「AI政策について…オープンな超党派議連を立ち上げる」とあります。', mission_manifesto_2_id, 4),
    (q_manifesto_2_5, category_manifesto_id, 'チームはやまのマニフェストの決め方で**誤っている**ものは？', 'チームはやまのミッション・ビジョンやステップ1〜3の方向性に合致している提案だけを採択対象とする。', '改善提案は AI で自動ラベリング・要約して整理する。', '最終的な反映方針をチームでまとめる。', 'チームが作成した反映方針を、AIが一件ずつ確認し、最終的な意思決定を行う。', 4, '最終的な意思決定は、党首である安野たかひろが一件ずつ確認し行うとしている。', mission_manifesto_2_id, 5);

    -- ミッションリンクの挿入
    -- 政策・マニフェストクイズ（中級）
    INSERT INTO mission_quiz_links (mission_id, link, remark, display_order) VALUES
    (mission_manifesto_1_id, 'https://policy.team-mir.ai/view/01_%E3%83%81%E3%83%BC%E3%83%A0%E3%81%BF%E3%82%89%E3%81%84%E3%81%AE%E3%83%93%E3%82%B8%E3%83%A7%E3%83%B3.md', '政策の「チームはやまのビジョン」のページ', 1);
    ...
    -- チームはやまクイズ（初級）
    INSERT INTO mission_quiz_links (mission_id, link, remark, display_order) VALUES
    (mission_team_1_id, 'https://team-mir.ai/', 'チームはやまHP', 1);
