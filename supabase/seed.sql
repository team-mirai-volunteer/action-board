...
VALUES
  ...
  ('b2345678-9abc-def0-1234-56789abcdef0', '(seed) SNSで政治的な投稿にいいね (1日2回)', '/img/mission_fallback.svg', 'SNSで政治に関する投稿を見つけて、いいねやリアクションをしてください。スクリーンショットを提出してください。', 2, NULL, 'LINK', NULL, 2),
  ('c3456789-abcd-ef01-2345-6789abcdef01', '(seed) 地域の政治活動を観察 (1日3回)', '/img/mission_fallback.svg', '地域で行われている政治活動（ポスター、街頭演説など）を観察し、写真を撮って報告してください。', 3, NULL, 'LINK', NULL, 3),
