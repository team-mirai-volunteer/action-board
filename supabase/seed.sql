...
INSERT INTO poster_boards (name, lat, long, prefecture, status, number, address, city, election_term, archived) VALUES
-- Tokyo boards
('東京駅前掲示板', 35.6812, 139.7671, '東京都', 'not_yet', '10-1', '千代田区丸の内1-9-1', '千代田区', 'sangin-2025', true),
('新宿駅南口掲示板', 35.6896, 139.7006, '東京都', 'done', '10-2', '新宿区新宿3-38-1', '新宿区', 'sangin-2025', true),
('渋谷駅ハチ公前掲示板', 35.6590, 139.7005, '東京都', 'done', '10-3', '渋谷区道玄坂2-1', '渋谷区', 'sangin-2025', true),
('池袋駅東口掲示板', 35.7295, 139.7104, '東京都', 'not_yet', '10-4', '豊島区南池袋1-28-2', '豊島区', 'sangin-2025', true),
('上野駅公園口掲示板', 35.7141, 139.7774, '東京都', 'reserved', '10-5', '台東区上野7-1-1', '台東区', 'sangin-2025', true),

-- Osaka boards
('大阪駅前掲示板', 34.7024, 135.4959, '大阪府', 'not_yet', '27-1', '北区梅田3-1-1', '大阪市北区', 'sangin-2025', true),
('なんば駅前掲示板', 34.6666, 135.5011, '大阪府', 'done', '27-2', '中央区難波5-1-60', '大阪市中央区', 'sangin-2025', true),
('天王寺駅前掲示板', 34.6465, 135.5133, '大阪府', 'error_damaged', '27-3', '天王寺区悲田院町10-45', '大阪市天王寺区', 'sangin-2025', true),

-- Kyoto boards (Note: Kyoto is not in the prefecture_enum, using nearby osaka)
('京都駅前掲示板', 34.9859, 135.7585, '大阪府', 'done', '27-4', '下京区烏丸通塩小路下る', '京都市下京区', 'sangin-2025', true),
('四条河原町掲示板', 35.0034, 135.7689, '大阪府', 'done', '27-5', '中京区河原町四条上る', '京都市中京区', 'sangin-2025', true),

-- Hokkaido boards
('札幌駅前掲示板', 43.0687, 141.3507, '北海道', 'not_yet', '01-1', '北区北七条西4丁目', '札幌市北区', 'sangin-2025', true),
('すすきの交差点掲示板', 43.0556, 141.3529, '北海道', 'reserved', '01-2', '中央区南四条西4丁目', '札幌市中央区', 'sangin-2025', true),

-- Fukuoka boards
('博多駅前掲示板', 33.5903, 130.4208, '福岡県', 'done', '40-1', '博多区博多駅中央街1-1', '福岡市博多区', 'sangin-2025', true),
...
-- 東京7区 (渋谷区)
('恵比寿東公園', 35.6481725, 139.7111924, '東京都', 'not_yet', '1-1', '恵比寿1丁目2番16号', '渋谷区', 'shugin-2026', '東京7区', false),
('伊達児童遊園地', 35.6444138, 139.7174316, '東京都', 'done', '1-3', '恵比寿3丁目11番2号', '渋谷区', 'shugin-2026', '東京7区', false),
('恵比寿駅東口公園', 35.646491, 139.7105855, '東京都', 'reserved', '1-4', '恵比寿4丁目2番6号', '渋谷区', 'shugin-2026', '東京7区', false),

-- 東京2区 (台東区・中央区)
('上野公園入口', 35.7141, 139.7774, '東京都', 'not_yet', '2-1', '台東区上野公園1-1', '台東区', 'shugin-2026', '東京2区', false),
('浅草寺前', 35.7148, 139.7967, '東京都', 'done', '2-2', '台東区浅草2-3-1', '台東区', 'shugin-2026', '東京2区', false),

-- 東京26区 (目黒区・大田区)
('目黒駅前', 35.6339, 139.7158, '東京都', 'not_yet', '26-1', '目黒区目黒1-1-1', '目黒区', 'shugin-2026', '東京26区', false),
('自由が丘駅前', 35.6076, 139.6686, '東京都', 'done', '26-2', '目黒区自由が丘1-1-1', '目黒区', 'shugin-2026', '東京26区', false),

-- 京都2区 (京都市左京区・東山区)
('上下水道局疏水事務所', 35.0159308, 135.7756504, '京都府', 'done', '左京区-1-1', '左京区聖護院蓮華蔵町35番地', '京都市', 'shugin-2026', '京都2区', false),
('元新洞小学校', 35.0120187, 135.7749702, '京都府', 'not_yet', '左京区-1-2', '左京区新東洞院町252番地', '京都市', 'shugin-2026', '京都2区', false),

-- 千葉5区 (市川市・浦安市)
('南八幡勤労福祉センター', 35.7136337, 139.9272993, '千葉県', 'not_yet', '32-1', '南八幡2丁目20-1', '市川市', 'shugin-2026', '千葉5区', false),
('市川駅北口', 35.7318, 139.9083, '千葉県', 'done', '32-2', '市川1丁目1-1', '市川市', 'shugin-2026', '千葉5区', false),
('浦安駅前', 35.6536, 139.8892, '千葉県', 'reserved', '33-1', '浦安市猫実1-1-1', '浦安市', 'shugin-2026', '千葉5区', false)
ON CONFLICT DO NOTHING;
