...
-- Tokyo boards
('東京駅前掲示板', 35.6812, 139.7671, 'tokyo', 'not_yet', '10-1', '千代田区丸の内1-9-1', '千代田区'),
('新宿駅南口掲示板', 35.6896, 139.7006, 'tokyo', 'posted', '10-2', '新宿区新宿3-38-1', '新宿区'),
('渋谷駅ハチ公前掲示板', 35.6590, 139.7005, 'tokyo', 'checked', '10-3', '渋谷区道玄坂2-1', '渋谷区'),
('池袋駅東口掲示板', 35.7295, 139.7104, 'tokyo', 'not_yet', '10-4', '豊島区南池袋1-28-2', '豊島区'),
('上野駅公園口掲示板', 35.7141, 139.7774, 'tokyo', 'reserved', '10-5', '台東区上野7-1-1', '台東区'),

-- Osaka boards
('大阪駅前掲示板', 34.7024, 135.4959, 'osaka', 'not_yet', '27-1', '北区梅田3-1-1', '大阪市北区'),
('なんば駅前掲示板', 34.6666, 135.5011, 'osaka', 'posted', '27-2', '中央区難波5-1-60', '大阪市中央区'),
('天王寺駅前掲示板', 34.6465, 135.5133, 'osaka', 'damaged', '27-3', '天王寺区悲田院町10-45', '大阪市天王寺区'),

-- Kyoto boards (Note: Kyoto is not in the prefecture_enum, using nearby osaka)
('京都駅前掲示板', 34.9859, 135.7585, 'osaka', 'posted', '27-4', '下京区烏丸通塩小路下る', '京都市下京区'),
('四条河原町掲示板', 35.0034, 135.7689, 'osaka', 'checked', '27-5', '中京区河原町四条上る', '京都市中京区'),

-- Hokkaido boards
('札幌駅前掲示板', 43.0687, 141.3507, 'hokkaido', 'not_yet', '01-1', '北区北七条西4丁目', '札幌市北区'),
('すすきの交差点掲示板', 43.0556, 141.3529, 'hokkaido', 'reserved', '01-2', '中央区南四条西4丁目', '札幌市中央区'),

-- Fukuoka boards
('博多駅前掲示板', 33.5903, 130.4208, 'fukuoka', 'posted', '40-1', '博多区博多駅中央街1-1', '福岡市博多区'),
('天神駅前掲示板', 33.5911, 130.3983, 'fukuoka', 'not_yet', '40-2', '中央区天神2丁目11-1', '福岡市中央区')
